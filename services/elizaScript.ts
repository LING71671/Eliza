...
export const englishScript: ElizaConfig = {
  ...
  keywords: [
    ...
    { pattern: /mother/i, responses: ["Tell me more about your mother.", "How was your relationship with your mother?", "Does she influence you?"] },
    { pattern: /father/i, responses: ["Tell me more about your father.", "How was your relationship with your father?", "Does he influence you?"] },
    { pattern: /child/i, responses: ["Did you have close friends as a child?", "What is your favorite childhood memory?", "Do you remember any dreams or nightmares from childhood?"] },
    { pattern: /dream/i, responses: ["What does that dream suggest to you?", "Do you dream often?", "What persons appear in your dreams?"] },
...
export const chineseScript: ElizaConfig = {
  ...
  keywords: [
    ...
    // Family (Consolidated)
    { pattern: /爸爸|父亲/i, responses: ["能不能说说你父亲的事？", "你和你父亲的关系怎么样？", "这让你想起了你的父亲吗？", "你父亲对你影响大吗？"] },
    { pattern: /妈妈|母亲/i, responses: ["能不能说说你母亲的事？", "你和你母亲的关系怎么样？", "这让你想起了你的母亲吗？", "你母亲是个什么样的人？"] },
    { pattern: /老婆|妻子|太太/i, responses: ["能不能说说你妻子的事？", "你们的关系怎么样？", "这让你想起了什么？"] },
    { pattern: /老公|丈夫|先生/i, responses: ["能不能说说你丈夫的事？", "你们的关系怎么样？", "这让你想起了什么？"] },
    { pattern: /孩子|小孩/i, responses: ["你喜欢孩子吗？", "能不能说说那个孩子的事？", "这让你想起了你的童年吗？", "孩子通常很可爱，不是吗？"] },
    { pattern: /家人|家庭/i, responses: ["你的家庭环境怎么样？", "你和家人很亲近吗？", "家对你来说意味着什么？"] },
    { pattern: /兄弟|姐妹|哥哥|姐姐|弟弟|妹妹/i, responses: ["能不能说说你兄弟姐妹的事？", "这让你想起了你的兄弟姐妹吗？", "你在家里排行第几？"] },

    // General / Abstract
    { pattern: /朋友/i, responses: ["你是在担心你的朋友吗？", "你朋友对你来说很重要吗？", "这让你想起了哪个朋友？", "你觉得自己朋友多吗？"] },
    { pattern: /梦见(.*)/i, responses: ["真的吗，梦见{0}？", "你以前做过这样的梦吗？", "你觉得这个梦意味着什么？", "梦里的{0}让你有什么感觉？"] },
    { pattern: /梦/i, responses: ["这个梦让你感觉如何？", "你经常做梦吗？", "这个梦里有谁？", "你醒来后是什么感觉？"] },
    ...
    { pattern: /工作|上班/i, responses: ["你的工作让你感到压力吗？", "你喜欢你的工作吗？", "工作对你的生活有什么影响？"] },
